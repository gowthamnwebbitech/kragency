                                ...
                                <table id="receiptTable" class="receipt-table">
                                    <thead>
                                        <tr class="receipt-row receipt-header-row">
                                            <th class="receipt-cell receipt-lot-details">Date</th>
                                            <th class="receipt-cell receipt-number">Description</th>
                                            <th class="receipt-cell receipt-amount">Amount ₹</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach($transactions as $transaction)
                                            <tr>
                                                <td class="receipt-cell">{{ $transaction->created_at->format('M d, Y h:i A') }}</td>
                                                <td class="receipt-cell">{{ $transaction->description }}</td>
